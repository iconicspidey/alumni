...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <div class="container p-10" style="padding: 20px;">
        <iframe style="width: 100%; height: 600px ;  overflow-x: hidden
    ;" src="https://docs.google.com/forms/d/e/1FAIpQLSeptTX6XjOntZsRLZqkamrd_NPQ128Tmw7Jf5zMgt3YW2fsQw/viewform?embedded=true"
            width="auto" height="auto" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
